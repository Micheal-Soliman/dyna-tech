          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-16">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-3">
                <div className="w-8 h-[2px] bg-[#0087cb]" />
              ...
              <h1 className="text-4xl md:text-6xl lg:text-[5rem] xl:text-[6rem] font-[1000] tracking-tighter uppercase italic leading-[0.9]">
                Our <span className="text-[#006db1]">Exclusive</span> <br/>
            ...
            <div className="max-w-md space-y-6">
              <div className="flex items-center gap-4 p-6 bg-[#006db1]/10 border border-[#006db1]/30">
                <div className="w-14 h-14 bg-[#006db1]/20 flex items-center justify-center">
                  <span className="font-[1000] text-2xl tracking-tighter uppercase italic text-[#006db1]">CU</span>
                </div>
                <div>
              ...
              <div className="flex items-center gap-4 p-6 bg-[#0087cb]/10 border border-[#0087cb]/30">
                <div className="w-14 h-14 bg-[#0087cb]/10 flex items-center justify-center">
                  <span className="font-[1000] text-2xl tracking-tighter uppercase italic text-[#0087cb]">FFT</span>
                </div>
                <div>
      ...
      <main className="py-32 space-y-48 px-6 md:px-16 lg:px-32 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-5 sticky top-32 space-y-12">
             <div className="aspect-square bg-zinc-950 border-2 border-white/10 flex flex-col items-center justify-center relative group overflow-hidden shadow-[0_0_50px_rgba(0,0,0,1)]">
                ...
                <div className="text-center group-hover:scale-110 transition-transform duration-700">
                    ...
                    <div className="h-px w-full bg-[#006db1] mt-2 shadow-[0_0_10px_#006db1]" />
                </div>
             ...
             <div className="space-y-8">
                <div className="space-y-4">
                    <div className="flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-[#006db1]">
                ...
                <div className="grid grid-cols-2 gap-px bg-white/5 border border-white/5">
                   <div className="p-4 bg-zinc-950 space-y-2">
                      <div className="text-[18px] font-[1000] text-[#006db1]">~350+</div>
                      <div className="text-[8px] font-black uppercase text-zinc-600">Member_Orgs</div>
                   </div>
                   <div className="p-4 bg-zinc-950 space-y-2">
                      <div className="text-[18px] font-[1000] text-[#006db1]">GLOBAL</div>
          ...
          <div className="lg:col-span-7 space-y-12 bg-zinc-950/50 border-2 border-white/10 p-10 md:p-20 relative">
             <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <span className="text-[#006db1] text-[10px] font-black tracking-[0.5em] uppercase italic">// MOD_EXCLUSIVE_REPRESENTATIVE</span>
             ...
             <div className="space-y-4">
                {["Training and Education", "Research and Development", "Localization of Lightweight Components"].map(item => (
                   <div key={item} className="flex items-center gap-6 p-6 border border-white/5 bg-black hover:border-[#006db1] transition-all group">
                      <div className="w-2 h-2 bg-[#006db1] group-hover:animate-ping" />
             ...
             <div className="pt-10 space-y-6">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    <Award size={16} className="text-[#006db1]" />
                ...
                <div className="p-8 bg-black border border-white/5 space-y-6 relative overflow-hidden">
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-[#006db1]">Hannover Messe 2022 Signing</p>
             ...
             <div className="flex flex-col gap-4">
               <a href="https://composites-united.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-6 w-full py-8 bg-white text-black font-[1000] uppercase text-[11px] tracking-[0.5em] hover:bg-[#006db1] transition-all group">
                  Official Website <ArrowUpRight size={16} className="group-hover:translate-x-1 transition-transform" />
               </a>
               <Link href="/accelerators/composites-united" className="flex items-center justify-center gap-6 w-full py-4 border border-[#006db1]/30 text-[#006db1] font-[1000] uppercase text-[10px] tracking-[0.5em] hover:bg-[#006db1]/10 hover:border-[#006db1] transition-all group">
        ...
        <section className="grid lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-5 sticky top-32 space-y-12">
             <div className="aspect-square bg-zinc-950 border-2 border-white/10 flex flex-col items-center justify-center relative group overflow-hidden shadow-[0_0_50px_rgba(0,0,0,1)]">
                ...
                <div className="text-center">
                    ...
                    <div className="h-px w-full bg-[#0087cb] mt-2 shadow-[0_0_10px_#0087cb]" />
                </div>
             ...
             <div className="space-y-8">
                <div className="space-y-4">
                    <div className="flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-[#0087cb]">
          ...
          <div className="lg:col-span-7 space-y-12 bg-zinc-950/50 border-2 border-white/10 p-10 md:p-20 relative">
             <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <span className="text-[#0087cb] text-[10px] font-black tracking-[0.5em] uppercase italic">// MOD_EXCLUSIVE_AGENCY</span>
                  <div className="h-px flex-grow bg-white/5" />
                </div>
             ...
             <div className="grid md:grid-cols-3 gap-4">
                {["Turnkey Production", "After Sales Support", "Digital Development"].map(item => (
                   <div key={item} className="p-6 border border-white/5 bg-black flex flex-col items-center justify-center text-center gap-4 group hover:border-[#0087cb] transition-all">
                      <ShieldCheck size={20} className="text-[#0087cb] group-hover:scale-125 transition-transform" />
             ...
             <div className="pt-10 space-y-6">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    <Award size={16} className="text-[#0087cb]" />
                    <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500 italic">Strategic Milestone</span>
                </div>
                <div className="p-8 bg-black border border-white/5 space-y-6 relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-4 text-[40px] opacity-10 italic font-black text-[#0087cb]">2023</div>
                    <p className="text-xs font-black uppercase tracking-widest text-[#0087cb]">Agreement signed at FFT Fulda</p>
                    <div className="aspect-video bg-zinc-900 border border-white/10 flex items-center justify-center grayscale group-hover:grayscale-0 transition-all duration-700">
             ...
             <div className="flex flex-col gap-4">
               <a href="https://fft.de" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-6 w-full py-8 border-2 border-[#0087cb]/30 text-[#0087cb] font-[1000] uppercase text-[11px] tracking-[0.5em] hover:bg-[#0087cb] hover:text-black hover:border-[#0087cb] transition-all group">
                  Official Website <ArrowUpRight size={16} className="group-hover:translate-x-1 transition-transform" />
               </a>
          ...
          <div className="max-w-4xl mx-auto space-y-24">
            ...
            <div className="grid md:grid-cols-2 gap-4">
               <div className="bg-zinc-950 border border-white/10 p-12 space-y-10 relative overflow-hidden group">
                  <div className="absolute -right-4 -top-4 w-24 h-24 bg-[#006db1]/5 rounded-full blur-3xl group-hover:bg-[#006db1]/10 transition-all" />
                  <h3 className="text-xl font-[1000] uppercase tracking-widest italic text-[#006db1]">CU_EGYPT_SCOPE</h3>
                  <ul className="space-y-5">
                     {["Material Transfer", "Localization", "R&D Programs", "LWM Training"].map(s => (
                        <li key={s} className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-zinc-400 pb-2 border-b border-white/5 italic">
                           {s} <CheckCircle2 size={12} className="text-[#006db1]" />
                        </li>
                     ))}
                  </ul>
               </div>
               <div className="bg-zinc-950 border border-white/10 p-12 space-y-10 relative overflow-hidden group">
                  <div className="absolute -right-4 -top-4 w-24 h-24 bg-[#0087cb]/5 rounded-full blur-3xl group-hover:bg-[#0087cb]/10 transition-all" />
                  <h3 className="text-xl font-[1000] uppercase tracking-widest italic text-[#0087cb]">FFT_EGYPT_SCOPE</h3>
                  <ul className="space-y-5">
                     {["Turnkey Production", "After Sales Service", "Digital Innovation", "Engineering Support"].map(s => (
                        <li key={s} className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-zinc-400 pb-2 border-b border-white/5 italic">
                           {s} <CheckCircle2 size={12} className="text-[#0087cb]" />
                        </li>
                     ))}
                  </ul>
               </div>
