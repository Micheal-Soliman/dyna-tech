...
import ServiceCompanyPage, {
  type ServicePartnersContent,
} from "@/components/services/ServiceCompanyPage";
...
type PartnersDictionary = {
  accelerators: ServicePartnersContent;
};
...
export default async function Page({
  ...
  return <ServiceCompanyPage partner={partner} ecosystemColumn={ecosystemColumn} locale={locale} />;
}
