          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-16">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-black tracking-[0.3em] uppercase text-[#006db1]">
                  CAREER_PORTAL
                </span>
              </div>
              ...
              <h1 className="text-4xl md:text-6xl lg:text-[5rem] xl:text-[6rem] font-[1000] tracking-tighter uppercase italic leading-[0.9]">
                Build <br/>
                <span className="text-[#0087cb]">Egypt&apos;s</span> <br/>
                <span className="text-zinc-800">Automotive</span> <br/>
                <span className="text-[#006db1]">Future.</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <a 
                  href="#positions"
                  className="px-8 py-4 bg-[#006db1] text-black text-[10px] font-[1000] uppercase tracking-[0.4em] hover:bg-white transition-all flex items-center gap-3"
                >
                  View Open Positions <ArrowRight size={16} />
                </a>
                <a 
                  href="#apply"
                  className="px-8 py-4 border border-white/20 text-white text-[10px] font-[1000] uppercase tracking-[0.4em] hover:border-[#0087cb] hover:text-[#0087cb] transition-all"
                >
                  Submit Application
                </a>
              </div>
            ...
            <div className="max-w-md space-y-5 p-6 bg-zinc-950/50 border border-white/10 backdrop-blur-sm">
              <div className="flex items-center gap-4 text-[#0087cb] pb-4 border-b border-white/10">
                <Factory size={20} />
              ...
              <div className="flex gap-4 pt-2">
                <div className="text-center">
                  <div className="text-2xl font-[1000] text-[#006db1]">4</div>
                  <div className="text-[8px] font-black uppercase tracking-widest text-zinc-600">Open Roles</div>
                </div>
                <div className="w-px bg-white/10" />
                <div className="text-center">
                  <div className="text-2xl font-[1000] text-[#0087cb]">2</div>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-16 lg:px-32">
        ...
        <section className="py-24 space-y-16">
          <div className="flex items-center gap-4">
            <span className="text-[10px] font-black tracking-[0.5em] uppercase text-[#006db1] italic">// WHY_DYNATECH</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10">
            {[
              ...
              <div key={i} className="bg-black p-10 space-y-6 group hover:bg-zinc-950/50 transition-all">
                <div className="text-[#006db1] group-hover:scale-110 transition-transform">
                  {item.icon}
                </div>
        ...
        <section className="py-24 space-y-12" id="positions">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8">
            <div className="space-y-4">
              <span className="text-[10px] font-black tracking-[0.5em] uppercase text-[#0087cb] italic">// OPEN_POSITIONS</span>
              <h2 className="text-4xl md:text-5xl font-[1000] uppercase italic tracking-tighter">
                Join The <span className="text-[#006db1]">Force.</span>
              </h2>
            </div>
            ...
            <div className="relative w-full lg:w-80">
              ...
              <input 
                ...
                className="w-full bg-zinc-950 border border-white/10 p-4 pl-12 text-[10px] font-black uppercase tracking-widest focus:border-[#0087cb] outline-none transition-all"
              />
            </div>
          </div>
            ...
            {Object.entries(FILTERS).map(([key, options]) => (
              <div key={key} className="flex items-center gap-2">
                ...
                <select 
                  ...
                  className="bg-black border border-white/10 px-4 py-2 text-[9px] font-black uppercase tracking-widest focus:border-[#0087cb] outline-none cursor-pointer"
                >
                  {options.map(opt => (
            ...
            {filteredPositions.length === 0 ? (
              ...
              filteredPositions.map((pos) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  className="group p-8 border border-white/5 bg-zinc-950/30 hover:border-[#0087cb]/50 transition-all cursor-pointer"
                >
                  <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                    <div className="space-y-3">
                      ...
                      <h3 className="text-2xl md:text-3xl font-[1000] uppercase italic tracking-tighter group-hover:text-[#0087cb] transition-colors">
                        {pos.title}
                      </h3>
                    ...
                    <button className="px-8 py-4 bg-white text-black text-[10px] font-[1000] uppercase tracking-widest hover:bg-[#006db1] transition-all flex items-center gap-3">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl md:text-5xl font-[1000] uppercase italic tracking-tighter">
                  Start Your <br/><span className="text-[#006db1]">Journey.</span>
                </h2>
              </div>
              ...
              <div className="space-y-4 pt-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 text-[10px] font-black uppercase text-zinc-600">
                    <CheckCircle2 size={14} className="text-[#006db1]" />
                    {step}
                  </div>
                ))}
              </div>
            ...
            <form className="p-10 bg-zinc-950 border-2 border-white/5 space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    className="w-full bg-black border border-white/10 p-4 text-xs font-mono focus:border-[#006db1] outline-none transition-all"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full bg-black border border-white/10 p-4 text-xs font-mono focus:border-[#006db1] outline-none transition-all text-zinc-400">
              ...
              <div className="space-y-2">
                ...
                <div className="h-32 border-2 border-dashed border-white/10 flex flex-col items-center justify-center gap-3 hover:border-[#006db1]/40 cursor-pointer transition-all bg-black">
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  className="w-full bg-black border border-white/10 p-4 text-xs font-mono focus:border-[#006db1] outline-none transition-all h-28 resize-none"
                  placeholder="Tell us why you want to join DYNATECH..."
                />
              </div>

              <button className="w-full py-6 bg-[#006db1] text-black text-[11px] font-[1000] uppercase tracking-[0.4em] hover:bg-white transition-all flex items-center justify-center gap-4">
