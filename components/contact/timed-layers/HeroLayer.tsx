  ...
  return (
    <Layer progress={progress} range={[-0.03, 0.08]}>
      <div className="text-center">
        <div className="flex items-center gap-3 justify-center text-[#bcd647] mb-6">
          <span className="w-2 h-2 bg-[#bcd647] rounded-full animate-ping" />
        ...
        <h1 className="text-[8vw] font-black italic leading-none tracking-tighter text-white">
          CONNECT_WITH <br /> <span className="text-[#bcd647]">DYNATECH.</span>
        </h1>
