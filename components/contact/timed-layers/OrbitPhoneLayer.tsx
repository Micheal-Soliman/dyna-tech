  ...
  return (
    <Layer progress={progress} range={[0.12, 0.22]} xOffset={-200}>
      <div className="flex items-center gap-6 bg-white/5 backdrop-blur-3xl p-8 rounded-[30px] border border-white/10 min-w-[400px]">
        <div className="w-14 h-14 bg-[#0087cb] text-black rounded-full flex items-center justify-center shadow-[0_0_20px_#0087cb]">
          <Phone size={20} />
        </div>
        <div>
          <p className="text-[#006db1] font-mono text-[9px] uppercase tracking-widest">{"// DIRECT_LINE"}</p>
