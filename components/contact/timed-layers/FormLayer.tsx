    ...
    <Layer progress={progress} range={[0.65, 0.88]}>
      <div className="w-full max-w-4xl bg-[#080808]/90 border border-white/10 backdrop-blur-3xl p-10 rounded-[40px]">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 bg-[#bcd647] rounded-full flex items-center justify-center mb-4 shadow-[0_0_30px_#bcd647]/30">
        ...
        <div className="flex items-center gap-3 text-[#bcd647] mb-8">
          <Terminal size={16} />
        ...
        <form className="grid grid-cols-2 gap-4 text-left">
          ...
          <input
            ...
            className="bg-white/5 border border-white/10 p-5 rounded-xl text-[10px] outline-none focus:border-[#bcd647]"
          />
          {/* Organization */}
          <input
          ...
          <input
            ...
            type="email"
            className="col-span-2 bg-white/5 border border-white/10 p-5 rounded-xl text-[10px] outline-none focus:border-[#bcd647]"
          />
          {/* Inquiry Type */}
          ...
          />
          {/* Submit */}
          <button className="col-span-2 py-6 bg-[#bcd647] text-black font-black uppercase text-[11px] tracking-[0.3em] rounded-xl hover:bg-white transition-all flex items-center justify-center gap-3">
