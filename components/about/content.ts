...
export const aboutContent: Record<Locale, DynatechContent> = {
  ...
  ar: {
    company: {
      ...
      lead: "",
      paragraphs: [
        "تأسست الشركة عام 2017 تحت اسم دايناتك كوربوريشن وعلامة (دايناتك) المسجلة والشركة التابعة لها دايناتك للتنمية الصناعية وبرأس مال مدفوع بالكامل بقيمة 15 مليون جنيه مصري. وتقوم دايناتك بالاستثمار لإنشاء مركز متكامل البنية التحتية لخدمة السيارات والتدريب والبحث والتطوير في التكنولوجيا المتقدمة لصناعة السيارات، وذلك لتطوير وتشغيل نموذج أعمال يجمع بين الشراكات الحصرية مع كيانات ومنصات تكنولوجية عالمية لخدمة قطاعات متعددة.",
        "هذا النموذج يخلق منظومة فريدة تربط بين مزودي التكنولوجيا العالميين وفرص نقل المعرفة وتوطين التكنولوجيا وبناء منصة تدعم نمو الأعمال وتساهم في دعم مستقبل قطاع صناعة السيارات في مصر.",
      ],
    },
    founder: {
      kicker: "القيادة",
    ...
    ceoMessage: {
      ...
      paragraphs: [
        "إنه لمن دواعي سرورنا اليوم أن نطلق موقع شركتنا الجديد DYNATECH، والذي سيمثل لعملائنا تجربة فريدة للتعرف على خدماتنا التي نقدمها من خلال شريكنا FFT Produktionssysteme، الشركة الألمانية الرائدة عالميا في أنظمة التصنيع المبتكرة والمرنة والمعقدة.",
        "FFT شركة متخصصة في تطوير وتخطيط مثل هذه المشاريع وتنفيذها في جميع أنحاء العالم في قطاعات السيارات والطيران والأجهزة المنزلية وغيرها.",
        "سيتيح موقعنا الجديد أيضا التعرف على خدمات شريكنا التكنولوجي Composites United (CU)، وهي واحدة من أكبر الشبكات في العالم لتصميم المواد المركبة والمكونات متعددة المواد الخفيفة مثل الألومنيوم والألياف الكربونية. وتتكون CU من 350 عضوا بارزا مثل Airbus وBMW وVW وغيرها، لتشكل في النهاية واحدة من أكبر الشبكات في العالم لتقديم تقنيات بحثية وتطوير حلول لتصميم المكونات والقطع من المواد خفيفة الوزن في قطاعات صناعية متعددة.",
        "ومن خلال موقعنا الجديد أيضا يمكن متابعة مراحل تطور مشروعنا الجديد في المنطقة الصناعية بالقاهرة الجديدة على مساحة تشغيلية 6,000 متر مربع، والذي سيكون علامة فارقة في سوق السيارات المصري كونه أول مركز خدمة سيارات متكامل تستخدم فيه تكنولوجيا Machine Learning وDigital Twin، والتي ستحول تكنولوجيا صيانة السيارات من الصيانة الوقائية إلى الصيانة التنبؤية. فمن خلال هذه المنصات المتقدمة للذكاء الاصطناعي أصبح من السهل التنبؤ والإنذار المبكر عن أي عطل قد يحدث في أي جزء في السيارة وتحديد مكانه بدقة، مما يسمح بالتدخل في الوقت المناسب لمنع الأعطال وتقليل تكاليف الإصلاح والوقت، مما يعود بالنفع على مالك السيارة.",
        "إن صناعة السيارات عالميا حاليا تمر بمرحلة تحول تكنولوجي متسارع وغير مسبوق، انتقالا من سيارات محركات الاحتراق الداخلي ICE إلى سيارات الطاقة الجديدة بأنواعها، وصولا لتصنيع سيارة تكون بمثابة منصة إلكترونية متحركة SDV ومتصلة بالشبكة وتعتمد على البرمجيات والتحديث عبر الهواء OTA ومنصات متقدمة للذكاء الاصطناعي لتحليل سلوكيات السائق والمركبة لتحسين السلامة والأداء.",
        "في النهاية، نحن نسعى كي تساهم شركتنا دايناتك مصر في تقديم الدعم للتطور الصناعي ونقل التكنولوجيا، وهو الهدف الذي تسعى إليه الدولة من خلال رؤية مصر 2030، لوضع مصر على الخريطة الجديدة لصناعة السيارات في العالم.",
      ],
