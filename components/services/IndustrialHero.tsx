...
export default function IndustrialHero({ smoothProgress }: Props) {
  return (
    <section className="h-screen flex flex-col justify-center items-center px-6 sticky top-0 z-0 overflow-hidden">
      ...
      >
        {/* Engineering Corners */}
        <div className="absolute -top-[2px] -left-[2px] w-16 h-16 border-t-4 border-l-4 border-[#bcd647]" />
        <div className="absolute -bottom-[2px] -right-[2px] w-16 h-16 border-b-4 border-r-4 border-[#43becc]" />

        <div className="flex items-center justify-center gap-4 mb-8">
           <span className="h-[1px] w-12 bg-[#bcd647]" />
           <p className="text-[#bcd647] tracking-[0.8em] text-[10px] font-black uppercase italic">Industrial_Intelligence</p>
           <span className="h-[1px] w-12 bg-[#bcd647]" />
        </div>
        
        <h1 className="text-6xl md:text-[9vw] font-[1000] italic uppercase leading-none tracking-tighter">
          DYNA<span className="text-[#bcd647]">TECH</span>
        </h1>
